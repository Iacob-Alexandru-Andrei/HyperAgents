...
class TaskAgent(AgentSystem):
    def forward(self, inputs):
        ...
        instruction += f"""
Here is a retrieval-style TOON review packet derived from the paper.
Use the abstract, ranked evidence chunks, and key tables as the paper evidence.
Chunk ranking favors method, experiment, result, comparison, limitation, and contribution evidence.
